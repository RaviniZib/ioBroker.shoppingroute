export type SourceCompatibility = 'source-ok' | 'known-bug' | 'unknown';
export type WriteCapability = 'source-ok' | 'live-ok' | 'known-bug' | 'live-failed' | 'unknown';
...
export function inspectAlexaRemoteSource(source: string): SourceInspection {
...
export function canWriteAlexa(capability: WriteCapability): boolean {
